		...
		<div class="col-group typecho-page-main">
			...
			switch ($act) {
				...
				case 'setting':
					...
					break;
				default:
					echo '<div id="duoshuo-remote-window" class="conbox"><p>多说实时同步插件 V1.1.3[基于多说官方SDK V0.3]</p><p>环境要求：PHP5.2+ & typecho0.9+</p><p>作　　者：<a href="http://ysido.com/" target="_blank">阳光</a> [xux851@gmail.com]</p><p>特别感谢：<a href="http://www.y2sky.com" target="_blank">燕儿</a><a href="http://www.binjoo.net/" target="_blank">冰剑</a><a href="http://mui.me" target="_blank">西西妹</a><a href="http://shang.qq.com/wpa/qunwpa?idkey=a5a8afedf099e18ddf9b530db9217251e39001d52aace42888bf470d9b6cb86a" target="_blank">Typecho机油群</a></p><p>其它说明：<ul class="tips"><li>1.本多说插件为Doby主题定制插件，请勿使用原作者发布的插件，未听劝解使用原版所造成后果Doby不负任何责任！</li><li>2.有时候会出现不能实时更新的问题，请稍后片刻，多说的服务器回PING有延时，若着急同步，请至扩展页点击同步即可</li><li>3.如若方便，请尽量在本地导出数据，远程可能会使你的主机不堪重负而罢工</li><li>4.因为插件暂时不支持本地操作同步远程，请用多说界面管理</li></ul></p></div>';
					break;
			}
			?>
		</div>
            ...
            success:function(response) {
            	if (response.code == 0){
            		if (rdigit.test(response.progress) && !isNaN(response.progress)){
            			<?php if($act == 'setting'):?>
            				$('#btn-export').html('同步完成,请个性化设置多说');
            				window.location.href="<?php $options->adminUrl('extending.php?panel=Duoshuo/manage-duoshuo.php&do=manage-preferences')?>";
            			<?php else: ?>
